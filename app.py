...
UI_TITLE = os.environ.get("UI_TITLE") or "MIA F&B Brasil"
UI_LOGO = os.environ.get("UI_LOGO")
UI_CHAT_LOGO = os.environ.get("UI_CHAT_LOGO")
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "Multi Intelligence Assistant - M.I.A."
UI_CHAT_DESCRIPTION = (
    os.environ.get("UI_CHAT_DESCRIPTION")
    or "Assistente Virtual da divisão F&B Brasil - Ecolab"
)
